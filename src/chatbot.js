...
export function initChatbot() {
  // Inject pulsing dots styles in header
  ...
  // 5. In-app navigation links (Event delegation)
  messagesContainer.addEventListener('click', (e) => {
    ...
    if (jumpLink) {
      ...
      if (subtopicId) {
        ...
        // On small displays, close the chat window on navigation to avoid screen clutter
